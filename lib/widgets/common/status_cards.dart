            ...
            Row(
              ...
              children: [
                ...
                StatItem(
                  ...
                  value: UnitsService.instance.formatVolume(
                    ((intake['goal'] as int) - (intake['current'] as int))
                        .clamp(0, 999999),
                    hideUnit: true,
                  ),
                  label: l10n.toGo,
            ...
            Row(
              ...
              children: [
                StatItem(
                  icon: Icons.water_drop,
                  value:
                      '+${UnitsService.instance.formatVolume(waterCorrection.round(), hideUnit: true)} ${UnitsService.instance.volumeUnit}',
          ...
          Row(
            ...
            children: [
              ...
              StatItem(
                ...
                value:
                    '${(maxCaffeine - todayCaffeine).clamp(0, maxCaffeine)}mg',
...
class _CaffeineRingWidgetState extends State<CaffeineRingWidget>
  ...
  Widget build(BuildContext context) {
    final percent = widget.max > 0
        ? (widget.consumed / widget.max * 100).clamp(0.0, 200.0)
        : 0.0;
...
class ElectrolyteStatusCard extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: const Icon(Icons.bolt, color: Colors.orange, size: 32),
            ),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Icon(Icons.bolt, size: 32, color: color),
              ),
              const SizedBox(width: 20),
              Expanded(
                child: Column(
  ...
  Color _getStatusColor() {
    ...
    final potassiumPercent =
        (totals['potassium']! / totals['potassiumGoal']!) * 100;
    final magnesiumPercent =
        (totals['magnesium']! / totals['magnesiumGoal']!) * 100;

    final avgPercent =
        (sodiumPercent + potassiumPercent + magnesiumPercent) / 3;
...
class TipItem {
  ...
  const TipItem({required this.emoji, required this.text});
}
