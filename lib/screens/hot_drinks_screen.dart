...
class _HotDrinksScreenState extends State<HotDrinksScreen>
  ...
  Future<void> _logIntake({
    ...
    try {
      ...
      final sugar = (baseSugar * volumeMl / 250)
          .toDouble(); // Proportional to 250ml default
      ...
      final intakeType = (itemType.contains('coffee') && caffeine > 0)
          ? 'coffee'
          : 'water';
      ...
      logger.e('Error logging hot drink: $e');
    }
  }
  ...
  Future<void> _saveToFavorites({
    ...
    final favorite = QuickFavorite(
      ...
      potassiumMg: 0,
      magnesiumMg: 0,
      metadata: {'hotDrinkType': item.properties['type'], 'caffeine': caffeine},
    );
