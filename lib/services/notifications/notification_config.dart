...
/// Конфигурация уведомлений HydroCoach
class NotificationConfig {
  ...
  static const int standardDrinkGrams =
      10; // Грамм чистого спирта в стандартном дринке
  static const int waterPerStandardDrink = 150; // мл воды на стандартный дринк
  static const int sodiumPerStandardDrink =
      100; // мг натрия на стандартный дринк
  ...
  static const String prefLastCoffeeNotificationTime =
